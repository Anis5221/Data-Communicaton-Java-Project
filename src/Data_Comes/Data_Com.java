...
public class Data_Com extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(reset);
        reset.setBounds(700, 360, 160, 50);
        ...
        combobox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select an Option", "Cipher Caesar", "Hamming Distance", "parity check", "Bit Stuffing", "Bit Destuffing", "Character Stuffing", "Character Destuffing" }));
        ...
        encode.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        encode.setForeground(new java.awt.Color(0, 51, 255));
        ...
        jPanel2.add(encode);
        encode.setBounds(690, 210, 170, 50);
        jPanel2.add(jLabel8);
        jLabel8.setBounds(0, 0, 890, 450);

        convert4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        convert4.setForeground(new java.awt.Color(0, 51, 255));
        convert4.setText("Bit Stuffing");
        convert4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                convert4ActionPerformed(evt);
            }
        });
        jPanel2.add(convert4);
        convert4.setBounds(690, 280, 170, 50);
...
//                             res = res + flag;
           ...
           result.setText(data1+res+data1);
      }
 ...
 if(combobox.getSelectedItem().equals("Cipher Caesar"))
           {
                ...
                if((s1.getText().equals("")))
                   ...
                   String ciphertext = s1.getText();
                    int shift = Integer.valueOf(s3.getText());
        ...
        result1.setText("Decoded");
                result.setText(decryptMessage);
